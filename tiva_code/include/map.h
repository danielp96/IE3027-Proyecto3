...
void map1_init()
{
    ...
    map1_nodes[16] = node_new( 44, 52);
    map1_nodes[17] = node_new( 68, 52);
    map1_nodes[18] = node_new( 92, 52);
    map1_nodes[19] = node_new(116, 52);
    map1_nodes[20] = node_new(140, 52);
    map1_nodes[21] = node_new(164, 52);

    map1_nodes[22] = node_new(  20, 76);
    map1_nodes[23] = node_new(  68, 76);
    map1_nodes[24] = node_new( 104, 76);
    map1_nodes[25] = node_new( 140, 76);
    map1_nodes[26] = node_new( 188, 76);
    ...
    map1_nodes[34] = node_new(  20, 124);
    map1_nodes[35] = node_new(  44, 124);
    map1_nodes[36] = node_new(  68, 124);
    map1_nodes[37] = node_new(  92, 124);
    map1_nodes[38] = node_new(  116, 124);
    map1_nodes[39] = node_new(  140, 124);
    map1_nodes[40] = node_new(  164, 124);
    map1_nodes[41] = node_new(  188, 124);

    map1_nodes[42] = node_new(  20, 148);
    map1_nodes[43] = node_new(  68, 148);
    map1_nodes[44] = node_new(  92, 148);
    map1_nodes[45] = node_new( 116, 148);
    map1_nodes[46] = node_new( 140, 148);
    map1_nodes[47] = node_new( 188, 148);

    map1_nodes[48] = node_new(  4, 172);
    map1_nodes[49] = node_new( 20, 172);
    map1_nodes[50] = node_new( 44, 172);
    map1_nodes[51] = node_new( 68, 172);
    map1_nodes[52] = node_new( 92, 172); 
    map1_nodes[53] = node_new(116, 172);
    map1_nodes[54] = node_new(140, 172);
    map1_nodes[55] = node_new(164, 172);
    map1_nodes[56] = node_new(188, 172);
    map1_nodes[57] = node_new(204, 172);

    map1_nodes[58] = node_new( 68, 196);
    map1_nodes[59] = node_new( 92, 196);
    map1_nodes[60] = node_new(116, 196);
    map1_nodes[61] = node_new(140, 196);

    map1_nodes[62] = node_new(  4,  220);
    map1_nodes[63] = node_new( 44,  220);
    map1_nodes[64] = node_new( 68,  220);
    map1_nodes[65] = node_new(140,  220);
    map1_nodes[66] = node_new(164,  220);
    map1_nodes[67] = node_new(204,  220);
